...
[ВВП]({site.info__vvp}) | $25,3 млрд (104 место) (2020)
[ВВП на душу]({site.info__vvp_on_unit}) | $4574 (146 место) (2019)
[ИЧР]({site.info__ichr}) | 0.594 (144 место) (2019)
[Коррупция]({site.info__corruption}) | 23 (157 место) (2021)
[Убийств на 100тыс]({site.info__kill_per_unit}) | 1,84 (59 место) (2011, JP, WHO)
[Ср. прод. жизни]({site.info__time_life}) | 70.1 (121 место) (2019, ВОЗ)

## Въезд

**Как подготовиться для легального въезда в страну с целью получения ВНЖ:**

При первом пересечении границы необходимо получить визу типа B (бизнес). ВНЖ не выдаётся, все живут по годовым рабочим или пенсионным визам. Продление без выезда из страны.
...
Есть список стран гражданам которых не рады в Камбодже. Страны СНГ туда не входят.

{% include edit %}

**Ограничения на ввоз в страну (валюта, личные вещи итд):**

Не было прицендентов. (Может быть продукты питания, лекарства?).

{% include edit %}

**Требования и ограничения для ввоза домашних животных:**

В Камбоджу разрешён ввоз домашних животных основных видов (собак, кошек, птиц) при условии наличия справок о прививках от заболеваний, типичных для конкретного вида животных.Также требуется сертификат о текущем состоянии здоровья животного, выданный уполномоченным ветеринарным врачом в стране отправления не ранее чем за 10 дней до въезда в Камбоджу.
{% include edit %}

**Ограничения связанные с COVID-19:**

Туристы с полной вакцинацией против Covid-19 въезжающие в Камбоджу воздушным, наземным и водным транспортом должны иметь: 1. Сертификат или паспорт вакцинации против Covid-19.2. 2. Сертификат об отрицательном результате на Covid-19 ( ПЦР тест) за 72 часа до вылета в Камбоджу из соответствующей страны. 3. Сделать экспресс-тест по прибытию в Камбоджу. Подождать результат 15-20 минут. Туристы, которые не были вакцинированы должны сделать ПЦР тест по прибытии и пройти 14-дневный карантин.
...
Туристическая виза выдаётся на 1 месяц и может быть продлена еще на 1 месяц.
...
Ни каких. Необходимо получить гражданство страны родителей.
...
Штраф- тюрьма-депортация. (Подробнее?)
